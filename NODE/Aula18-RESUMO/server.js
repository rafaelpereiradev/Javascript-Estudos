...
const helmet = require('helmet'); // recomendado pelo expresss, deixa a plaicação mais segura.
const {
  meuMiddleware,
  verificaCSRF,
  csrfMiddleware,
...
const sessionOptions = session({ //configurando sessoes, guardando sessoes etc...
